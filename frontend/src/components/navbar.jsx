...
function Navbar() {
    ...
    <nav className="bg-indigo-600 h-1/6 p-6 text-white flex items-center justify-between">
        <img src="" alt="Logo" />
        <button className="flex items-center mt-10 opacity-60 p-2 rounded-xl hover:bg-indigo-800 hover:opacity-100 focus:bg-indigo-800 focus:opacity-100">
        ...
        <button className="flex mt-10 opacity-60 p-2 rounded-xl hover:bg-indigo-800 hover:opacity-100 focus:bg-indigo-800 focus:opacity-100">
            <div className="flex gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
